<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="CustomerRegistration.aspx.cs" Inherits="WAPP2502.CustomerRegisteration" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <table class="table">
        ...
        <tr>
            ...
            <td>
                ...
                <asp:Label ID="lblPicture" runat="server" ForeColor="#FF6600"></asp:Label>
            </td>
        </tr>
        <tr>
            <td>
    ...
    <p>
        ...
        <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:wappConnectionString1 %>" DeleteCommand="DELETE FROM [tblCustomers] WHERE [CID] = @CID" InsertCommand="INSERT INTO [tblCustomers] ([firstName], [lastName], [email], [password], [age], [gender], [country], [picture], [dtRegistered]) VALUES (@firstName, @lastName, @email, @password, @age, @gender, @country, @picture, @dtRegistered)" SelectCommand="SELECT * FROM [tblCustomers]" UpdateCommand="UPDATE [tblCustomers] SET [firstName] = @firstName, [lastName] = @lastName, [email] = @email, [password] = @password, [age] = @age, [gender] = @gender, [country] = @country, [picture] = @picture, [dtRegistered] = @dtRegistered WHERE [CID] = @CID" OnSelecting="SqlDataSource1_Selecting">
            <DeleteParameters>
            ...
            <InsertParameters>
                ...
                <asp:ControlParameter Name="password" Type="String" ControlID="txtPassword" PropertyName="Text" />
                <asp:ControlParameter ControlID="txtAge" Name="age" PropertyName="Text" Type="Int32" />
                <asp:ControlParameter ControlID="rdoGender" Name="gender" PropertyName="SelectedValue" Type="String" />
                <asp:ControlParameter ControlID="ddlCountry" Name="country" PropertyName="SelectedValue" Type="String" />
                <asp:ControlParameter ControlID="lblPicture" Name="picture" PropertyName="Text" Type="String" />
                <asp:ControlParameter ControlID="lblDateTime" Name="dtRegistered" PropertyName="Text" Type="DateTime" />
            </InsertParameters>
            <UpdateParameters>
